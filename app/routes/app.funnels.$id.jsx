...
export async function loader({ request, params }) {
  ...
  const findRes = await db.product.findUnique({
    where: {
...
export const action = async ({ request, params }) => {
  ...
  const dbState = await db.product.update({
...
export default function Index() { 
    ...
    console.log(funnel.triggeredTitle);
  ...
  const [selected, setSelected] = useState(`${funnel.discount}`);
  const [triggered, setTriggered] = useState({title: funnel.triggeredTitle, id: funnel.triggeredId});
  const [offered, setOffered] = useState({title: funnel.offeredTitle, id: funnel.offeredId});
